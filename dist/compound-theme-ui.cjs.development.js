...
function createUIComponent(component) {
 ...
 // populate jsx props
    ...
    return React.createElement(UIContext.Provider, {
      value: context
    }, themeUi.jsx(component, jsxProps));
  };
...
var useUIContext = function useUIContext(props) {
  ...
  var parentContext = React.useContext(UIContext); // don't use parent context if root
...
exports.ui = ui;
//# sourceMappingURL=compound-theme-ui.cjs.development.js.map
